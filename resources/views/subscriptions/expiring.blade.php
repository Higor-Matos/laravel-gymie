...
@section('content')
    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Assinaturas a expirar
                <small>Detalhes de todas as assinaturas a expirar</small>
            </h1>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Assinaturas a expirar</small>
            </h1>
            @endpermission
        </div><!-- / PageHead -->
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="gymie_paging_info">
                                            Exibindo página {{ $expirings->currentPage() }} de {{ $expirings->lastPage() }}
                                        </div>
                                    </div>
